...
import { authService, useAuthConfig } from '../_components/AuthConfig';
...
export default function AuthPage() {
  ...
  const { isAWS, toggleMode, getAuthMode } = useAuthConfig();
  ...
  const companyHint = React.useMemo(() => {
    ...
    return `We'll connect you to ${domain} if it's already on CogNexus2`;
  }, [email]);

  // Honor ?mode= from the URL
  React.useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 w-full overflow-x-hidden">
      ...
      {/* Environment Toggle - positioned absolutely */}
      <div className="absolute top-4 right-4 z-20 flex items-center space-x-4">
        <div className="text-xs text-white/60">
          Mode: {getAuthMode().toUpperCase()}
        </div>
        <button
          onClick={toggleMode}
          className="text-xs text-white/80 hover:text-white border border-white/20 px-2 py-1 rounded backdrop-blur-sm bg-slate-800/50"
        >
          Switch to {isAWS ? 'Local' : 'AWS'}
        </button>
      </div>
          ...
          <div className="max-w-md">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-white font-semibold mb-1">Document Intelligence</h3>
                  <p className="text-gray-400 text-sm">Ask questions about specs, drawings, and RFIs in plain language</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Spot delays and risks before they impact your timeline</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Keep everyone aligned with automated meeting summaries</p>
                </div>
              </div>
            </div>
          </div>
